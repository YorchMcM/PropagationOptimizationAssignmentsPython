...
plt.figure()
plt.semilogy((diff[:,0] - diff[0,0]) / 60.0, abs(diff[:,1]) / 1000.0, label = 'x')
plt.semilogy((diff[:,0] - diff[0,0]) / 60.0, abs(diff[:,2]) / 1000.0, label = 'y')
plt.semilogy((diff[:,0] - diff[0,0]) / 60.0, abs(diff[:,3]) / 1000.0, label = 'z')
plt.semilogy((diff[:,0] - diff[0,0]) / 60.0, np.linalg.norm(diff[:,1:4], 2, 1) / 1000.0, label = 'Norm')
plt.xlabel('Time since beginning of simulation [minutes]')
plt.title(title)
plt.legend()
plt.grid()